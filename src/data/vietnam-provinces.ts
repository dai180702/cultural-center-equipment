...
export const parseAddress = (
  ...
  if (
    parts[0] &&
    (parts[0].includes("Phường") ||
      parts[0].includes("Xã") ||
      parts[0].includes("Thị trấn"))
  ) {
    return { province: parts[1]?.trim() || "", district: parts[0].trim() };
  } else {
    return { province: parts[0].trim(), district: parts[1]?.trim() || "" };
  }
};

export const formatAddress = (province: string, district: string): string => {
